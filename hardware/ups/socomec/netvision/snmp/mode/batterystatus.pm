...
package hardware::ups::socomec::netvision::snmp::mode::batterystatus;
...
sub run {
    ...
    my $oid_upsBattery = '.1.3.6.1.4.1.4555.1.1.1.1.2';
    my $oid_upsBatteryStatus = '.1.3.6.1.4.1.4555.1.1.1.1.2.1.0';
    my $oid_upsEstimatedMinutesRemaining = '.1.3.6.1.4.1.4555.1.1.1.1.2.3.0';
    my $oid_upsEstimatedChargeRemaining = '.1.3.6.1.4.1.4555.1.1.1.1.2.4.0';
    my $oid_upsBatteryVoltage = '.1.3.6.1.4.1.4555.1.1.1.1.2.5.0'; # in dV
    my $oid_upsBatteryTemperature = '.1.3.6.1.4.1.4555.1.1.1.1.6.0'; # in degrees Centigrade
