...
my $oids = {
    '.1.3.6.1.4.1.4555.1.1.1.1.3.2' => { name => 'upsInputFrequency', factor => 0.1 }, # in dH
    '.1.3.6.1.4.1.4556.1.1.1.1.3.3.1.2' => { name => 'upsInputVoltage', factor => 0.1 }, # in Volt
    '.1.3.6.1.4.1.4555.1.3.3.1.3.3.1.3' => { name => 'upsInputCurrent', factor => 0.1 }, # in dA
};

sub manage_selection {
    my ($self, %options) = @_;

    my $oid_upsInputEntry = '.1.3.6.1.4.1.4555.1.1.1.1.3.3.1';
