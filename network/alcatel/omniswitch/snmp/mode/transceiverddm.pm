...
package network::alcatel::omniswitch::snmp::mode::transceiverddm;
...
sub run {
	...
	my $oid_ddmTemperature = '.1.3.6.1.4.1.6486.800.1.2.1.5.1.1.2.5.1.1';
	my $oid_ddmSupplyVoltage = '.1.3.6.1.4.1.6486.800.1.2.1.5.1.1.2.5.1.6';
	my $oid_ddmTxBiasCurrent = '.1.3.6.1.4.1.6486.800.1.2.1.5.1.1.2.5.1.11';
	my $oid_ddmTxOutputPower = '.1.3.6.1.4.1.6486.800.1.2.1.5.1.1.2.5.1.16';
	my $oid_ddmRxOpticalPower = '.1.3.6.1.4.1.6486.800.1.2.1.5.1.1.2.5.1.21';
