...
package network::alcatel::6900::snmp::mode::hardware;

use base qw(centreon::plugins::templates::hardware);
use network::alcatel::6900::snmp::mode::components::resources qw(%oids);
...
sub set_system {
    ...
    $self->{components_path} = 'network::alcatel::6900::snmp::mode::components';
