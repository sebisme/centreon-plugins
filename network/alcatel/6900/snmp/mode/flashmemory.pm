...
package network::alcatel::6900::snmp::mode::flashmemory;
...
sub run {
    ...
    my $oid_chasSupervisionFlashMemEntry = '.1.3.6.1.4.1.6486.801.1.1.1.3.1.1.9.1';
    my $oid_chasSupervisionFlashSize = '.1.3.6.1.4.1.6486.801.1.1.1.3.1.1.9.1.2'; # in B
    my $oid_chasSupervisionFlashFree = '.1.3.6.1.4.1.6486.801.1.1.1.3.1.1.9.1.3'; # in B
