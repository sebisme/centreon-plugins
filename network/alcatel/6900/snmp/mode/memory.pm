...
package network::alcatel::6900::snmp::mode::memory;
...
sub run {
    ...
    # my $oid_healthDeviceMemory1MinAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.10'; # it's '.0' but it's for walk multiple
    # my $oid_healthDeviceMemory1HrAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.11'; # it's '.0' but it's for walk multiple
    my $oid_healthModuleMemory1MinAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.1.1.8';
    my $oid_healthModuleMemory1HrAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.1.1.9';
