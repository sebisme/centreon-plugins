...
package network::alcatel::6900::snmp::mode::cpu;
...
sub run {
    ...
    my $oid_healthModuleCpu1MinAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.1.1.11'; # it's '.0' but it's for walk multiple
    my $oid_healthModuleCpu1HrAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.1.1.1.12'; # it's '.0' but it's for walk multiple
    # my $oid_healthModuleCpu1MinAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.2.1.1.1.1.15';
    # my $oid_healthModuleCpu1HrAvg = '.1.3.6.1.4.1.6486.801.1.2.1.16.1.1.2.1.1.16';
