...
#
package cloud::aws::ec2::mode::network_packets;
        ...
        metrics => [
            {
                ...
                value_format => '%d',
                threshold_format => '%s',
                short_msg => 'Network packets in : %d',
                long_msg => 'Network packets in : %d',
                get_min_max => 1
            },
            {
                ...
                value_format => '%d',
                threshold_format => '%s',
                short_msg => 'Network packets out : %d',
                long_msg => 'Network packets out : %d',
                get_min_max => 1
            }
        ]
    };
